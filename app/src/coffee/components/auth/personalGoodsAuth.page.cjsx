...
Auth = React.createClass {
	...
	render: ->
		cells = [
			...
			isOpt = @state.user?.personalGoodsStatus isnt 1 and @state.user?.personalGoodsStatus isnt 0
			...
			<ul>
				<li>
					<h6 className="xert-h6">真实姓名</h6>
						{
							if @state.user.name and @state.user.personalGoodsStatus is 1 or @state.user.personalGoodsStatus is 0
				...
				<li>
					<h6 className="xert-h6">身份证号</h6>
						{
							if @state.user.idCardNo and @state.user.personalGoodsStatus is 1 or @state.user.personalGoodsStatus is 0
		...
		{
			if @state.user.personalGoodsStatus isnt 1 and @state.user.personalGoodsStatus isnt 0
