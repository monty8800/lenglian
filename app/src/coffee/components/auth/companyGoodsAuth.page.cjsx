...
Auth = React.createClass {
	...
	render: ->
		cells = [
			...
			isOpt = @state.user?.enterpriseGoodsStatus isnt 1 and @state.user?.enterpriseGoodsStatus isnt 0
			...
			<ul>
				<li>
					<h6 className="xert-h6">公司名称</h6>
						{
							if @state.user.company and @state.user.enterpriseGoodsStatus is 1 or @state.user.enterpriseGoodsStatus is 0
				...
				<li>
					<h6 className="xert-h6">公司电话</h6>
						{
							if @state.user.tel and @state.user.enterpriseGoodsStatus is 1 or @state.user.enterpriseGoodsStatus is 0
		...
		{
			if @state.user.enterpriseGoodsStatus isnt 1 and @state.user.enterpriseGoodsStatus isnt 0
