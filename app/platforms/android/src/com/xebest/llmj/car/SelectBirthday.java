...
import com.xebest.llmj.widget.NumericWheelAdapter;
...
public class SelectBirthday extends PopupWindow implements OnClickListener {
	...
	public SelectBirthday(Activity context, String title) {
		super(context);
		mContext = context;
...
//		this.age = "2015-10-15";
		...
		tvTitle = (TextView) mMenuView.findViewById(R.id.title);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.cancel:
				dateCallBack.callBack(0, age);
				break;
			case R.id.submit:
				if (mTitle.equals("开始时间")) {
					dateCallBack.callBack(1, age);
				} else {
					dateCallBack.callBack(2, age);
				}
