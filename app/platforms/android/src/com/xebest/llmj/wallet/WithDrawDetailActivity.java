 ...
 */
public class WithDrawDetailActivity extends BaseCordovaActivity implements CordovaInterface {
    ...
    public void jsCallNative(JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (flag.equalsIgnoreCase("withdraw:done")) {
//            AddBankNextActivity.actionView(this);
            MainActivity.actionView(this, 3);
        }
    }
    ...
    protected void onResume() {
        ...
        mWebView.init(this, ApiUtils.API_COMMON_URL + "withdrawDetail.html", this, this, this, this);
        super.onResume();
    }
